...
![Banner Aplikasi](imge/kelasin.png)
...
![Tampilan Login](assets/img/login.png)
*Tampilan awal (login).*

### 2. Modul Manajemen Data Terpadu
![Tampilan Register](assets/img/register.png)
*Antarmuka Pendaftaran akun.*

### 3. Formulir Input & Validasi Pintar
![Tampilan Dashboard](assets/img/dashboard1.png)
